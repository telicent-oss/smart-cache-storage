...
/**
 * LMDB-based implementation of DictionaryLabelsStore. Uses three named databases: - labels_to_ids  : label bytes ->
 * long id - ids_to_labels  : long id -> label bytes - meta           : metadata (currently just next_id)
 */
